...
$finder = (new PhpCsFixer\Finder())
    ...
    // Auto-generated by Symfony's cache:warmup (config builder classes for IDE autocompletion),
    // regenerated on every `composer install`/`cache:clear` with its own formatting.
